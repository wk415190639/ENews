...
public class Vitamio {
  ...
  public static boolean isInitialized(Context ctx) {
    ...
    android.util.Log.e("", "isInitialized: "+vitamioPackage+"  <>" +vitamioLibraryPath +"< >"+browserlibraryPath);
  ...
  public static final String getDataPath() {
      ...
      android.util.Log.i("", " static initializer getDataPath:sss> "+vitamioDataPath);
